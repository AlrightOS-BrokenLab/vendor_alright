...
ALARM_PATH := vendor/alright/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/alright/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/alright/prebuilt/common/media/audio/ringtones
